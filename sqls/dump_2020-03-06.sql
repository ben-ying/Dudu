...
2	t	t	t	2018-12-21	2020-03-04	2	5000	80000
1	t	t	t	2018-12-20	2020-03-05	1	4000	60000
\.
...
SELECT pg_catalog.setval('public.django_admin_log_id_seq', 3431, true);
...
SELECT pg_catalog.setval('public.iaer_about_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.iaer_iaer_id_seq', 2268, true);
