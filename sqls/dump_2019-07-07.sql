...
SELECT pg_catalog.setval('iaer_iaer_id_seq', 1557, true);
...
SELECT pg_catalog.setval('iaer_redenvelope_id_seq', 93, true);
...
2	t	t	t	2018-12-21	2019-07-02	2	5000	80000
1	t	t	t	2018-12-20	2019-06-30	1	1000	20000
\.
