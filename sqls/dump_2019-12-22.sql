...
4	pbkdf2_sha256$100000$wJAFdVCMDAc1$aJ/WKhuWY6SxeS/iNx3zHgSDSNvEsH51osrRYllCuaU=	2019-12-09 16:59:32.016303+08	t	admin	Ben	Ying	benying1988@gmail.com	t	t	2018-11-20 16:59:15+08
\.
...
COPY public.iaer_about (id, version_name, version_code, apk, category, comment, datetime) FROM stdin;
\.
...
1	t	t	t	2018-12-20	2019-12-21	1	1000	20000
2	t	t	t	2018-12-21	2019-12-10	2	5000	80000
\.
...
SELECT pg_catalog.setval('public.iaer_about_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.iaer_iaer_id_seq', 2104, true);
