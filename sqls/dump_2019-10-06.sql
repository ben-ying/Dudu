...
4	pbkdf2_sha256$100000$wJAFdVCMDAc1$aJ/WKhuWY6SxeS/iNx3zHgSDSNvEsH51osrRYllCuaU=	2019-09-07 05:05:32.225762+00	t	admin	Ben	Ying	benying1988@gmail.com	t	t	2018-11-20 08:59:15+00
\.
...
SELECT pg_catalog.setval('django_admin_log_id_seq', 3410, true);
...
SELECT pg_catalog.setval('iaer_iaer_id_seq', 1803, true);
...
101	55	0	而	方法	2019-09-10 08:04:17.294184+00	4
...
SELECT pg_catalog.setval('iaer_redenvelope_id_seq', 101, true);
...
1	t	t	t	2018-12-20	2019-10-06	1	1000	20000
\.
