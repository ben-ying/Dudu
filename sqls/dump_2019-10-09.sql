...
4	pbkdf2_sha256$100000$wJAFdVCMDAc1$aJ/WKhuWY6SxeS/iNx3zHgSDSNvEsH51osrRYllCuaU=	2019-10-09 10:09:46.153644+00	t	admin	Ben	Ying	benying1988@gmail.com	t	t	2018-11-20 08:59:15+00
\.
...
SELECT pg_catalog.setval('django_admin_log_id_seq', 3416, true);
...
SELECT pg_catalog.setval('iaer_iaer_id_seq', 1813, true);
...
SELECT pg_catalog.setval('iaer_redenvelope_id_seq', 133, true);
...
2	t	t	t	2018-12-21	2019-09-30	2	5000	80000
1	t	t	t	2018-12-20	2019-10-09	1	1000	20000
\.
