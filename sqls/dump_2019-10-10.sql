...
SELECT pg_catalog.setval('django_admin_log_id_seq', 3421, true);
...
90	2800	0	妈妈	两岁生日红包	2019-06-09 13:23:01.246619+00	4
...
SELECT pg_catalog.setval('iaer_redenvelope_id_seq', 140, true);
...
2	t	t	t	2018-12-21	2019-10-09	2	5000	80000
\.
