...
class PhotoAdmin(admin.ModelAdmin):
    ...
    list_display=('id', 'name', 'user', 'exif_image_width', 'exif_image_height', 'get_read_size', 'url_link', 'thumbnail_link', 'duration', 'exif_model', 'exif_datetime', 'category', 'pub_date', 'modify_date')
