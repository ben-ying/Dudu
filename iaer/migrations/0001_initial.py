# Generated by Django 2.0.5 on 2018-09-03 12:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime', models.DateTimeField(auto_now=True, null=True)),
                ('baby', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='iaer.BabyUser')),
            ],
        ),
        migrations.CreateModel(
            name='Event',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='iaer.BabyUser')),
            ],
        ),
        migrations.CreateModel(
            name='Like',
            fields=[
                ...
                ('datetime', models.DateTimeField(auto_now=True, null=True)),
                ('baby', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='iaer.BabyUser')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='iaer.Event')),
            ],
        ),
        migrations.CreateModel(
            name='LoginLog',
        ...
        migrations.AddField(
            model_name='comment',
            name='event',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='iaer.Event'),
        ),
        migrations.AddField(
            model_name='comment',
            name='source_comment',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='iaer.Comment'),
        ),
    ]
