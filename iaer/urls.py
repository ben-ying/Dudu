...
from iaer.views.comment_views import CommentViewSet
from iaer.views.event_views import EventViewSet, like_view, multiply_events_view, delete_all_events_view
from iaer.views.views import send_feedback, about_us_view, RedEnvelopeViewSet, IaerViewSet
